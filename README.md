...
```
npm create cloudflare@latest -- --template=cloudflare/templates/multiplayer-globe-app
```

A live public deployment of this template is available at [https://multiplayer-globe-app.templates.workers.dev](https://multiplayer-globe-app.templates.workers.dev)
